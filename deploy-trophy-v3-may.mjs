...
async function deploy() {
  ...
  console.log("📦 Step 1/4: Deploying clarityxotrophyv3 to mainnet...\n");
  ...
  contractCode = contractCode.replace(/[--]/g, "-");
  ...
  console.log(
    "   ✓ Deployment broadcasted. Waiting 60 seconds for confirmation...\n"
  );
  await delay(60000);

  // Step 2: Set month URI
  console.log("📸 Step 2/4: Setting May image URI...\n");
  ...
  // Step 3: Set mint fee
  console.log("💰 Step 3/4: Setting mint fee to 0.02 STX...\n");
  ...
  console.log("🏆 Step 4/4: Setting May's top 5 winners...\n");
  ...
  console.log("Mint Fee:  0.02 STX (20,000 uSTX)");
  console.log(
    "Image URI: https://scarlet-large-hummingbird-596.mypinata.cloud/ipfs/bafybeib6x6w7u4emwb4k7ky757xhw4u367ttykskchj6q522ttd2jh4fgm/"
  );
  console.log("\nTop 5 Winners:");
  MAY_TOP_5.forEach((addr, i) => {
    console.log(`  ${i + 1}. ${addr}`);
  });
  console.log("\n🎁 Winners can now claim their trophies!");
}
