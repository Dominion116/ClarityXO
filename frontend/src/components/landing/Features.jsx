const FEATURES = [
  ...
  { icon: "◎  Monthly Rewards", tag: "Incentives", title: "Trophy NFT System", desc: "Monthly leaderboard resets at month end. Top 5 scorers earn a unique ClarityXO Trophy NFT minted to their wallet.", chips: ["NFT", "Rewards"] },
